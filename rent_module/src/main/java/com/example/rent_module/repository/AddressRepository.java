...
public interface AddressRepository extends JpaRepository<AddressEntity, Long> {
    ...
    @Query(value = "select a from AddressEntity a where a.city = :city and a.street = :street and a.numberOfHouse = :numberOfHouse and a.numberOfApartment = :numberOfApartment")
